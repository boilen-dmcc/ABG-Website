...
export const Mandate = ({ data }: Props) => {
      ...
      >
        ...
        >
          <div className="relative w-full aspect-[4/5] bg-gray-100 overflow-hidden">
            <img
              src={data.mandatePortrait}
              alt={data.mandatePortraitAlt}
