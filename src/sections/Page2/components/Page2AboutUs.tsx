...
export const Page2AboutUs = () => {
  ...
  const videoPreview = {
    overlayTitle: "Our Vision",
    overlayDescription:
      "Al Barham Group delivers integrated solutions across energy, construction, logistics, real estate, and investment with a focus on reliability and long-term value.",
    ctaTitle: "See Al Barham Group in motion",
    ctaSubtitle: "Watch the video",
    duration: "",
  };

  const videoUrl =
    "https://cdn.jsdelivr.net/gh/SaintFredMax/abg-assets@main/ABG%20Video%20Preview.mp4";
  const posterUrl = "./images/cta-collaborate.jpeg";
          ...
          >
            ...
            <div className="vision-gap relative z-20 flex flex-col p-5 sm:p-6 md:p-10">
              ...
              <a
                ...
                aria-label="Watch the Al Barham Group video"
              >
